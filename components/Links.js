...
export function Links() {
  return (
    <div className={classes.grid}>
      ...
      <a href="https://github.com/vercel/next.js/tree/canary/examples" className={classes.card}>
      ...
      >
        ...
        <p className={classes.description}>Instantly deploy your Next.js site to a public URL with Vercel.</p>
      </a>
    </div>
  );
}
